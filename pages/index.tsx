      ...
      <div>
         <Image
          ...
          <Link
            ...
            target="_blank"
          >
          <div className="flex 2xl:gap-4 gap-2 flex-wrap py-12 cursor-pointer transition transform-y hover:scale-110 2xl:text-[25px] text-[20px] justify-center text-center font-bold mt-6">
